        ...
        <div class="col-md-8">
            <div class="form-card card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('notas.update', [$usuario->idusuario, $nota->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="tipo-option" onclick="selectTipo('info')">
                                        <input type="radio" name="tipo" value="info" id="tipo_info" {{ old('tipo', $nota->tipo) == 'info' ? 'checked' : '' }} hidden>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <div class="tipo-option" onclick="selectTipo('seguimiento')">
                                        <input type="radio" name="tipo" value="seguimiento" id="tipo_seguimiento" {{ old('tipo', $nota->tipo) == 'seguimiento' ? 'checked' : '' }} hidden>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <div class="tipo-option" onclick="selectTipo('resuelto')">
                                        <input type="radio" name="tipo" value="resuelto" id="tipo_resuelto" {{ old('tipo', $nota->tipo) == 'resuelto' ? 'checked' : '' }} hidden>
                                        <div class="d-flex align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="tipo-option" onclick="selectTipo('importante')">
                                        <input type="radio" name="tipo" value="importante" id="tipo_importante" {{ old('tipo', $nota->tipo) == 'importante' ? 'checked' : '' }} hidden>
                                        <div class="d-flex align-items-center">
                                    ...
                                    <div class="tipo-option" onclick="selectTipo('problema')">
                                        <input type="radio" name="tipo" value="problema" id="tipo_problema" {{ old('tipo', $nota->tipo) == 'problema' ? 'checked' : '' }} hidden>
                                        <div class="d-flex align-items-center">
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" 
                                       ...
                                       name="es_privada" 
                                       value="1"
                                       {{ old('es_privada', $nota->es_privada) ? 'checked' : '' }}>
                        ...
                        <div class="mb-4 p-3 bg-light rounded">
                            <small class="text-muted">
                                <strong>Creada por:</strong> {{ $nota->autor->nombre }} {{ $nota->autor->apellido }} • 
                                <strong>Fecha:</strong> {{ $nota->created_at->format('d/m/Y H:i') }}
                                @if($nota->updated_at->ne($nota->created_at))
                                    • <strong>Última modificación:</strong> {{ $nota->updated_at->format('d/m/Y H:i') }}
                                @endif
                            </small>
                        </div>
