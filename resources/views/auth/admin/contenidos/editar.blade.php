            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.contenidos.actualizar', $contenido->idcontenido) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        required
                                        value="{{ old('nombre', $contenido->nombre) }}"
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        class="form-control"
                                        rows="3"
                                    >{{ old('descripcion', $contenido->descripcion) }}</textarea>
                                </div>
                                    ...
                                    <select name="idcategoria" class="form-control" required>
                                        ...
                                        @foreach($categorias as $cat)
                                            <option value="{{ $cat->idcategoria }}"
                                                {{ (string)old('idcategoria', $contenido->idcategoria) === (string)$cat->idcategoria ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        required
                                        value="{{ old('fechapublicacion', $contenido->fechapublicacion) }}"
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        Si no subes un nuevo archivo, se mantiene el actual.
                                    </small>
